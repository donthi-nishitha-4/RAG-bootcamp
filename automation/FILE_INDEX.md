# 📑 BOOTCAMP AUTOMATION SYSTEM - FILE INDEX

---

## 📋 CORE FILES MAP

| **File** | **Role** | **Priority** | **Team Member** |
| :--- | :--- | :--- | :--- |
| [Final_Deliverables/Documentation.md](file:///home/ecs/aipms-rag-bootcamp/Final_Deliverables/Documentation.md) | Final RAG Bootcamp Deliverables | **CRITICAL** | ALL |
...
```
/home/ecs/aipms-rag-bootcamp/
├── README.md                              <- Project Overview (Restored)
├── Final_Deliverables/
│   ├── Documentation.md                   <- PRIMARY AUTO-UPDATED DOC
│   └── Documentation_Template.md          <- Pure template (for backup)
├── automation/
...
└── experiments/                           <- Your experimental data (Proof)
```
...
1.  Read **[QUICK_START_5_STEPS.md](file:///home/ecs/aipms-rag-bootcamp/automation/QUICK_START_5_STEPS.md)**.
2.  Follow the **Git Branch Flow**: `feature/[yourname]/[experiment-name]`.
3.  Use **[MASTER_SUBMISSION_PROMPT.md](file:///home/ecs/aipms-rag-bootcamp/automation/MASTER_SUBMISSION_PROMPT.md)** to update your deliverables via Claude.
