BALU Plan and Task Distribution

Overview
--------
This document captures the next work items (assigned to BALU) required to finish the bootcamp deliverables. Files created for this work include experiment templates, evaluation query set placeholders, retrieval/reranker stubs, chunker skeletons, and RAGAS setup notes (all suffixed with _UDAY).
...
How to use
- Use the experiment template for every experiment you run; commit one file per experiment to a branch named `BALU/<short-task-name>`.
