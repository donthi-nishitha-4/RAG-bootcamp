...
- Experiment logs (one per experiment): `experiments/uday-<id>_UDAY.md`
...
- Create branch `uday/<task-short-name>` for each major item. Example: `uday/queries-30`
