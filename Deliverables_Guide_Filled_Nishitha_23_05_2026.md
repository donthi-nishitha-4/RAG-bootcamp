...
<td><span style="color:#E74C3C;">Native PostgreSQL Graph Strategy - Recursive CTEs give sub-20ms latency without extra infra.</span></td>
<td><span style="color:#E74C3C;">ADD Section 5, graph_rag_test_Nishitha.md</span></td>
</tr>
...
<td><span style="color:#E74C3C;">RobustLLM Failover - Sequential failover ensures 100% router uptime.</span></td>
<td><span style="color:#E74C3C;">ADD Section 6, query_router_test_Nishitha.md</span></td>
</tr>
...
<td><span style="color:#E74C3C;">ADD Section 4, src/core/agent_Nishitha.py</span></td>
</tr>

<tr style="background-color:#F2F4F4;">
<td><b>Fusion Strategy</b></td>
<td>RRF, CombSUM, CombMNZ</td>
<td><span style="color:#E74C3C;">RRF - Provided 3% improvement in overall pass rate in Day 10 evals.</span></td>
<td><span style="color:#E74C3C;">eval_hybrid_...md vs eval_vector_...md</span></td>
</tr>
...
<tr>
<td><b>Fix Applied (if any)</b></td>
<td><span style="color:#E74C3C;">Pre-retrieval OOD Filter in hardening_Nishitha.py.</span></td>
</tr>
...
<td><span style="color:#E74C3C;">25</span></td>
<td><span style="color:#E74C3C;">25</span></td>
<td><span style="color:#E74C3C;">0</span></td>
<td><span style="color:#E74C3C;">100%</span></td>
<td><span style="color:#E74C3C;">None</span></td>
...
<b>What actually happened:</b> <span style="color:#E74C3C;">Achieved 100% accuracy in the controlled Router Test (query_router_test_Nishitha.md).</span>  
<b>Why it happened (root cause):</b> <span style="color:#E74C3C;">RobustLLM framework with sequential failover and specific domain instructions.</span>  
<b>Production implication for AI-PMS:</b> <span style="color:#E74C3C;">Sequential API failover is essential to prevent router downtime.</span>
...
<tr>
<td><b>Strategy / Config</b></td>
<td><span style="color:#E74C3C;">Regex + Keyword Classifier in hardening_Nishitha.py.</span></td>
</tr>
<tr>
<td><b>Dataset Used</b></td>
...
<tr>
<td><b>Hypothesis</b></td>
<td><span style="color:#E74C3C;">RobustLLM failover maintains 100% routing accuracy during site queries.</span></td>
</tr>
<tr>
<td><b>Strategy / Config</b></td>
...
<tr>
<td><b>Latency</b></td>
<td><span style="color:#E74C3C;">936ms avg</span></td>
</tr>
<tr>
<td><b>Result (vs. baseline)</b></td>
<td><span style="color:#E74C3C;">Perfect routing achieved.</span></td>
</tr>
<tr style="background-color:#FCF3CF;">
<td><b>Surprising Finding</b></td>
<td><span style="color:#E74C3C;">Latency remains stable (<1s) despite complex failover logic.</span></td>
</tr>
<tr style="background-color:#FDEBD0;">
<td><b>Production Implication</b></td>
